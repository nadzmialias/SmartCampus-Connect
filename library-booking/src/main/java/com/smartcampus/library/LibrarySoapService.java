...
// This annotation defines the class as a SOAP Web Service
...
public class LibrarySoapService {
    ...
    // Operation 1: Fulfills the "SOAP Fault" requirement
    ...
    public Book checkBookAvailability(@WebParam(name = "bookId") String bookId) throws Exception {
        ...
        if (bookOpt.isEmpty()) {
            // Throwing a standard Java Exception here forces Apache CXF to generate a strict "SOAP Fault" XML response!
    ...
    // Operation 2: A quick helper method to populate our database
